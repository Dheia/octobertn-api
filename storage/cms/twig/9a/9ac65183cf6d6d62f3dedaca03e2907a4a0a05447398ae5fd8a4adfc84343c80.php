...
/* M:\DATA\octobertn/themes/toannang/layouts/master.htm */
class __TwigTemplate_529c8c5192ed9cbe1eb9b5591ca4d02886b3af55ad5ceca2d8753d6024d6f36d extends \Twig\Template
{
    private $source;
...
<body class=\"";
    ...
    ";
        ...
        echo $this->env->getExtension('Cms\Twig\Extension')->componentFunction("LeptHpcosmeticsHeader"        , $context['__cms_component_params']        );
    ...
    {
        return "M:\\DATA\\octobertn/themes/toannang/layouts/master.htm";
    }
...
<body class=\"{{ this.page.baseFileName }}\">
    <div class=\"wrapper\"></div>
    {% component 'LeptHpcosmeticsHeader' %}
    {% page %}
...
</html>", "M:\\DATA\\octobertn/themes/toannang/layouts/master.htm", "");
    }
}
